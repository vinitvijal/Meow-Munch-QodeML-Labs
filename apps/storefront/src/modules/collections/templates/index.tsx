        ...
        <div className="min-h-screen px-4 py-8 md:px-10 lg:px-14 max-w-[1440px] mx-auto w-full">
            ...
            <div className="mb-8">
                <nav className="flex items-center text-sm text-[#61896f] mb-4">
                    ...
                    <span className="text-[#111813] font-medium">{collection.title}</span>
                </nav>
                <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                    <div>
                        <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-[#111813]">{collection.title}</h1>
                    </div>
                </div>
            </div>
